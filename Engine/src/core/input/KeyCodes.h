...
namespace Phoenix {
	...
	namespace Key
	{
		enum : KeyCode
		{
			...
			SHOWINFO				= GLFW_KEY_1,
			SHOWRENDERTIME			= GLFW_KEY_2,
			SHOWFBO					= GLFW_KEY_3,
			SHOWALLFBO				= GLFW_KEY_4,
			SHOWRENDERSECTIONINFO	= GLFW_KEY_5,
			SHOWSOUNDSECTIONINFO	= GLFW_KEY_6,
			SHOWSOUND				= GLFW_KEY_7,
			SHOWCONFIG				= GLFW_KEY_8,
			SHOWHELP				= GLFW_KEY_9,
			SHOWDEBUGNET			= GLFW_KEY_F5,
			SHOWDEBUGMEMORY			= GLFW_KEY_F6,
			SHOWMENU				= GLFW_KEY_F8,

...
// Instrumentor from TheCherno/Hazel project, credits here: https://github.com/TheCherno/Hazel
...
#define PX_PROFILE_BEGIN_SESSION(name, filepath) ::Phoenix::Instrumentor::Get().BeginSession(name, filepath)
#define PX_PROFILE_END_SESSION() ::Phoenix::Instrumentor::Get().EndSession()
#define PX_PROFILE_SCOPE(name) constexpr auto fixedName = ::Phoenix::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
									::Phoenix::InstrumentationTimer timer##__LINE__(fixedName.Data)

...
// Adds an empty Texture into the queue, returns the ID of the texture added
int TextureManager::addEmptyTexture(int width, int height, int iformat, int format, int type) {

...
namespace Phoenix {
	...
	enum class SectionCommand : char const {
		IDENTIFIER = 0,
		START,
		END,
		LAYER,
	...
	enum class SectionVariableType : char const {
		TYPE_INT = 0,
		TYPE_FLOAT,
		TYPE_STRING
	};
	...
	private:
		...
		const std::map<std::string, SectionCommand> spoSectionCommand = {

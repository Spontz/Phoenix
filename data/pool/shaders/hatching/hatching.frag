...
uniform sampler2D screenTexture; // Texture to hatch
uniform vec2 iResolution;

// Credits goes to: https://www.shadertoy.com/view/MdX3Dr

// How close together hatch lines should be placed (10.0 recommended)
uniform float density;
// How wide hatch lines are drawn (1.0 or higher recommended)
uniform float width;
